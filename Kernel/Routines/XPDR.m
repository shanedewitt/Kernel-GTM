XPDR ;SFISC/RSD - Routine File Edit ;09/17/96  10:05
 ;;8.0;KERNEL;**1,2,44,393,547,10003**;Jul 10, 1995;Build 15
 ; *10003* changes (c) Sam Habiel 2018 - Increase routine name lengths
 Q
UPDT ;update routine file
 N DIR,DIRUT,XPD,XPDI,XPDJ,XPDN,XPDGTM,X,X1,Y,Y1,% W !
 W ! S DIR(0)="FO^1:17^K:X'?.1""-""1U.7UNP X",DIR("A")="Routine Namespace",DIR("?")="Enter 1 to 16 characters, preceed with ""-"" to exclude namespace" ; *10003* 8 -> 16
