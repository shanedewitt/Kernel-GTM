XPDUTL ;SFISC/RSD - KIDS utilities ;2018-06-11  12:35 PM
 ;;8.0;KERNEL;**21,28,39,81,100,108,137,181,275,491,511,559,10003**;Jul 10, 1995;Build 4
...
PATCH(X) ;return 1 if patch X was installed, X=aaaa*nn.nn*nnn
 Q:X'?1.4UN1"*"1.2N1"."1.2N.1(1"V",1"T").2N1"*"1.10N 0 ; *10003* Support up to 10 digits in the patch number
 N %,I,J
 S I=$$LKPKG($P(X,"*")) Q:'I 0
