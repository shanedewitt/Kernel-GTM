KMPVPST2 ;SP/JML - VSM VERSION 2 POST INSTALL ROUTINE ;Aug 02, 2018@14:11
 ;;4.0;CAPACITY MANAGEMENT;*10003*;3/1/2018;Build 38
 ;
 ; *10003* -> (c) Sam Habiel 2018
 ; *10003* -> Change all emails to POSTMASTER
 ;
 ;
 ...
 S FDA($J,8969,"+3,",3.01)="POSTMASTER"
 S FDA($J,8969,"+3,",3.02)="POSTMASTER"
 S FDA($J,8969,"+3,",3.03)="POSTMASTER"
 ; VMCM
 ...
 S FDA($J,8969,"+4,",3.01)="POSTMASTER"
 S FDA($J,8969,"+4,",3.02)="POSTMASTER"
 S FDA($J,8969,"+4,",3.03)="POSTMASTER"
 ; VHLM
 ...
 S FDA($J,8969,"+5,",3.01)="POSTMASTER"
 S FDA($J,8969,"+5,",3.02)="POSTMASTER"
 S FDA($J,8969,"+5,",3.03)="POSTMASTER"
 ...
 S FDA($J,8969.02,"+3,",1.01)="POSTMASTER"
 S FDA($J,8969.02,"+3,",1.02)="POSTMASTER"
 S FDA($J,8969.02,"+3,",1.03)="POSTMASTER"
 ; VMCM
 ...
 S FDA($J,8969.02,"+4,",1.01)="POSTMASTER"
 S FDA($J,8969.02,"+4,",1.02)="POSTMASTER"
 S FDA($J,8969.02,"+4,",1.03)="POSTMASTER"
 ; VHLM
 ...
 S FDA($J,8969.02,"+5,",1.01)="POSTMASTER"
 S FDA($J,8969.02,"+5,",1.02)="POSTMASTER"
 S FDA($J,8969.02,"+5,",1.03)="POSTMASTER"
 D UPDATE^DIE("","FDA($J)","ZIEN","KMPVERR")
