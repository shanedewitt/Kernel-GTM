...
RUN ; Collect metrics per configured interval and store in ^KMPTMP("KMPV","VMCM","DLY" -- CALLED VIA CACHE TASK MANAGER
 ...
 ..S H=H_"Link State"
 ..D HEAD^KMPVLOG(H,"KMPV","VMCM",1)  ; / *10001*
 ...
 .;
 .I '$$VA^KMPVLOG D  ; *10001* Write to file outside VA
 ..N KMPOUT,C
 ..S C=0
 ..N LNAME S LNAME=""
...
SEND ; Format and send data to CPE once a day -- TASKED VIA TASKMAN
 I '$$VA^KMPVLOG QUIT  ; *10001* Outside of the VA don't send anything
